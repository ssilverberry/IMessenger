...
public class ChatRoomsDAOimpl {
    ...
    private static final com.group42.server.controller.ChatRoomsDAOimpl instance = new com.group42.server.controller.ChatRoomsDAOimpl();
    private PreparedStatement preparedStatement;
    private ResultSet resultSet;

    private Connection connection = DAOHandler.getInstance().getConnection();

    public static com.group42.server.controller.ChatRoomsDAOimpl getInstance() {
        if (instance != null)
            return instance;
        else
            return new com.group42.server.controller.ChatRoomsDAOimpl();
    }
