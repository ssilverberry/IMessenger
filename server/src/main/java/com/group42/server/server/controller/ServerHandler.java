...
import com.group42.server.controller.ChatRoomsDAOimpl;
...
public class ServerHandler {
    ...
    private static final Logger lOGGER = LogManager.getLogger(com.group42.server.controller.ServerHandler.class);
