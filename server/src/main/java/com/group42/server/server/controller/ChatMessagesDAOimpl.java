...
import com.group42.server.controller.UsersDAOimpl;
...
public class ChatMessagesDAOimpl {
    ...
    private static final com.group42.server.controller.ChatMessagesDAOimpl instance = new com.group42.server.controller.ChatMessagesDAOimpl();
    private Connection connection = DAOHandler.getInstance().getConnection();
    private PreparedStatement prepStatement;
    private ResultSet resultSet;


    public static com.group42.server.controller.ChatMessagesDAOimpl getInstance() {
        if (instance != null)
            return instance;
        else
            return new com.group42.server.controller.ChatMessagesDAOimpl();
    }
