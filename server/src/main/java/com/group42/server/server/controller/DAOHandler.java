...
import com.group42.server.controller.DAO;
...
public class DAOHandler implements DAO {
    ...
    private static final Logger LOG = LogManager.getLogger(com.group42.server.controller.DAOHandler.class);
    private String name;
    private String password;
    private String url;
    private Connection connection;
    private static final com.group42.server.controller.DAOHandler instance = new com.group42.server.controller.DAOHandler();
    ...
    public static com.group42.server.controller.DAOHandler getInstance() {
        if (instance != null)
            return instance;
        else
            return new com.group42.server.controller.DAOHandler();
    }
}
